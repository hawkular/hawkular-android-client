...
public final class BackendClient {
    ...
    public void saveCred(String key, String secret) {
        ...
        session.setAccountId("hawkular");
        session.setAccessToken(key + ":" + secret);
        getAuthorizationModule().addAccount(session);
    }

    public void configureAuthorization() {
        ModuleKeeper.modules.put("hawkular", new SecretStoreAuthzModule(activity.getApplicationContext()));
    }
    ...
    private SecretStoreAuthzModule getAuthorizationModule() {
    ...
    public void authorize(@NonNull Activity activity, @NonNull Callback<String> callback,
                          String username, String password, URL backendUrl) {
        getAuthorizationModule().requestAccess(callback, username, password, backendUrl);
    }
    ...
    private <T> void readPipe(String pipeName, URI uri, Callback<List<T>> callback) {
        Timber.d(pipeName + "  :  " + getPipe(pipeName).getUrl().toString() + getFilter(uri).getLinkUri().getRawPath());
