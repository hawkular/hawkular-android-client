...
public class LoginActivity extends AppCompatActivity implements Callback<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        port=bundle.getString("port");  // chances of being null
    ...
    public void onSuccess(String authorization) {
        try {
            ...
            Preferences.of(LoginActivity.this).key().set(auth.getString("key"));
            Preferences.of(LoginActivity.this).secret().set(auth.getString("secret"));
            setUpBackendCommunication(getMockPersona());
